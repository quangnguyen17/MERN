...
const NewAuthor = ({ author }) => {
    ...
    return (
        <div>
            ...
            <br />
            <Form onSubmit={onSubmit} className="m-3 p-4 bg-light rounded">
                ...
                <Button variant="secondary" onClick={() => {
                    navigate('/');
                    setContext(null);
                }} className="my-4 mx-1">Cancel</Button>
                <Button ref={submitRef} variant="success" type="submit" className="my-4 mx-1">{(author && author !== undefined) ? 'Update Author' : 'Add Author'}</Button>
            </Form>
        </div>
    );
}
